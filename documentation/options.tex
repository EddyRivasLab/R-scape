...
and a PDB file is provided (using option \prog{--pdbfile}), the
...
Option \prog{--pdbfile} is incompatible with \prog{--fold}.
...
\user{bin/R-scape --cntmaxD 4 --cntmind 3 --pdbfile tutorial/3f2q.pdb -s --onlypdb tutorial/RF00050.sto}\\
