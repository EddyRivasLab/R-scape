...
\noindent
These two options are not incompatible with each other. If both a consensus structure is provided, and a PDB
file, the contacts in the PDB file will be used to augment the consensus structure. No conflicts are resolved.
