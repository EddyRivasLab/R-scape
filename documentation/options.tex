...
\subsubsection{\prog{--E\_neg <x>}}   Pairs with E-value larger than the E-value cutoff but smaller than <x> will not be called negatives regardeless of their covariation power. Default for E\_neg is 1.0.
