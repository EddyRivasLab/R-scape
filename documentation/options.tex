...
minimum length of the two sequences.  Sequences with at least $x$
pairwise similarity are clustered together, and one representative of
the cluster is randomly selected. If this option is not used all
