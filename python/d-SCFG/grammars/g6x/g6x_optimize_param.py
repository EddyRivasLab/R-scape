...
from grammars.g6x import g6x_inside, g6x_params
...
def get_argparse():
    ...
    parser.add_argument('--grm_file', type=str, default="../../lib/tornado/grammars/g6x.grm",
                        help='file with grammar definition')
    parser.add_argument('--postgrm_file', type=str, default="../../lib/tornado/grammars/g6x.grm",
...
def optimize_param_G6X(args, rundir, K, mask, psq, log_psq, grad_accum, verbose):
    ...
    if init_tornado:
        ...
        log_t0, t0, log_t1, t1, log_t2, t2, e_single, pe_single, e_pair, pe_pair = g6x_params.G6X_param_tornado(verbose)
    elif init_random:
        print("initialization: random")
        log_t0, t0, log_t1, t1, log_t2, t2, e_single, pe_single, e_pair, pe_pair = g6x_params.G6X_param_random(K, verbose)
    else:
        print("initialization: uniform")
        log_t0, t0, log_t1, t1, log_t2, t2, e_single, pe_single, e_pair, pe_pair = g6x_params.G6X_param_uniform(K, verbose)
    ...
    init_params = g6x_params.G6X_normalize_params(init_params, scaled)
    ...
    epoch = 0
    params = init_params
    param_file = g6x_params.G6X_write_paramfile(rundir, epoch, params)
    ...
    if os.path.exists(test_file):
        ...
        param_file_ML = "../../lib/tornado/notebook/05-2025/g6x/TORNADO_"+train_name+"_g6x.param"
        ...
        if os.path.exists(param_file_ML):
            ...
            params_ML = g6x_params.G6X_read_paramfile(param_file_ML, False)
        
        param_file_ML_best = "../../lib/tornado/notebook/05-2025/g6x/TORNADO_TORNADO_TrATrBTrB_g6x.param"
        if os.path.exists(param_file_ML_best):
            ...
            params_ML_best = g6x_params.G6X_read_paramfile(param_file_ML_best, False)
        ...
        if os.path.exists(param_file_ML):
            g6x_params.G6X_plot_params(rundir, epoch, params, params_ML, param_file_ML)
        else:
            g6x_params.G6X_plot_params(rundir, epoch, params, params_ML_best, param_file_ML_best)
    ...
    for epoch in range(1,n_epoch):
        ...
        params = g6x_params.G6X_normalize_params(params, scaled)
...
def main(args):
    ...
    optimize_param_G6X(args, rundir, K, mask, psq, log_psq, grad_accum, verbose)
