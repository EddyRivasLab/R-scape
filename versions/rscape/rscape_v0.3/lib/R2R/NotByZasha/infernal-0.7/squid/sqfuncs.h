 ...
 *
 * SVN $Id: sqfuncs.h 1526 2005-12-13 20:20:13Z eddy $
 */
...
extern void     FMX2Copy(float **mx_dest, float **mx_src, int m, int n);
...
/* from wuss.c
 */
extern int  WUSS2ct(char *ss, int len, int allow_pseudoknots, int **ret_ct);
extern void WUSStoKHS(char *ss);
extern void KHStoWUSS(char *ss);
