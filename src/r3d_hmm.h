...
#define HMM_tB   0.9999 
#define HMM_tI   0.005
#define HMM_tM   0.99925
#define HMM_tMI  0.00025
#define HMM_tD   0.00025
#define HMM_tDI  0.00025
...
typedef struct {
  ...
  SCVAL    *dp_mem;		/* memory allocated for the resizable DP matrix          */
...
extern R3D_HMM *R3D_hmm_Create(const ESL_ALPHABET *abc, char *RMmotif, char *errbuf, int verbose);
