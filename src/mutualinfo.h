...
extern int              Mutual_SignificantPairs_Ranking(struct mutual_s *mi, int *ct, FILE *rocfp, FILE *sumfp, int maxFP, int maxDecoy, double expectFP, double ratioFP, 
							int nbpairs, int ishuffled, int verbose, char *errbuf);
extern int              Mutual_SignificantPairs(struct mutual_s *mi, int *ct, FILE *rocfp, FILE *sumfp, int maxFP, double expectFP, double ratioFP,
						int nbpairs, int verbose, char *errbuf);
extern int              Mutual_SignificantPairs_Shuffled(struct mutual_s *mi, int *ct, FILE *rocfp, FILE *sumfp, int maxDecoy, double expectFP, double ratioFP, 
int nbpairs, int verbose, char *errbuf);
