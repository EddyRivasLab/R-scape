...
extern int              Mutual_Calculate(ESL_MSA *msa, ESL_TREE *T, struct ribomatrix_s *ribosum, struct mutual_s *mi, 
					 METHOD method, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, double tol, int verbose, char *errbuf);
...
extern int              Mutual_CalculateCHI (struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, int analyze, double tol, int verbose, char *errbuf);
extern int              Mutual_CalculateOMES(struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, int analyze, double tol, int verbose, char *errbuf);
extern int              Mutual_CalculateGT  (struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, int analyze, double tol, int verbose, char *errbuf);
extern int              Mutual_CalculateMI  (struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, int analyze, double tol, int verbose, char *errbuf);
extern int              Mutual_CalculateMIr (struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, int analyze, double tol, int verbose, char *errbuf);
extern int              Mutual_CalculateCOVCorrected(struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, CORRTYPE corrtype, double tol, int verbose, char *errbuf);
...
extern int              Mutual_SignificantPairs_Ranking(struct mutual_s *mi, int *ct, FILE *rocfp, int maxFP, double ratioFP, int ishuffled, int verbose, char *errbuf);
