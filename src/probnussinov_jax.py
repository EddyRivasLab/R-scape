...
def ProbNuss_Inside_JAX(K: int, min_hairpin: int = 0):
...
def test_ProbNuss_Inside_JAX(L: int, min_hairpin: int = 0):
    K = 4
    epsilon = 1e-3
    ...
    probnuss_inside_jax = ProbNuss_Inside_JAX(K, min_hairpin)
...
def main():
    ...
    test_ProbNuss_Inside_JAX(L, min_hairpin=0)
    test_ProbNuss_Inside_JAX(L, min_hairpin=3)
