...
extern int       Tree_CalculateExtFromMSA(ESL_RANDOMNESS *r, ESL_MSA **omsa, ESL_TREE **ret_T, int shuffle_seqs, int rootatmid, char *errbuf, int verbose);
extern int       Tree_CreateExtFile(const ESL_MSA *msa, char **ret_treefile, char *errbuf, int verbose);
extern int       Tree_FitchAlgorithmAncenstral(ESL_RANDOMNESS *r, ESL_TREE *T, ESL_MSA *msa, ESL_MSA **ret_allmsa, int *ret_sc, int profmark, char *errbuf, int verbose);
...
extern int       Tree_Substitutions(ESL_RANDOMNESS *r, ESL_MSA *msa, ESL_TREE *T, int **ret_nsubs, int **ret_ndouble, int **ret_njoin, int includegaps, char *errbuf, int verbose);
