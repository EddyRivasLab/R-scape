...
extern int       esl_tree_er_Rescale(double scale, ESL_TREE **ret_T);
extern int       esl_tree_er_RescaleAverageTotalBL(double target_tbl, ESL_TREE **ret_T, double tol, char *errbuf, int verbose);
extern int       esl_tree_er_RescaleAverageBL(double target_abl, ESL_TREE **ret_T, double tol, char *errbuf, int verbose);
