...
extern int   CYKCOV_Fill(struct mutual_s *mi, CLIST *clist, COVLIST *explained, GMX *cyk, SCVAL *ret_sc, 
			 THRESH *thresh, char *errbuf, int verbose);
extern int   CYKCOV_Traceback(ESL_RANDOMNESS *r, struct mutual_s *mi, CLIST *clist, COVLIST *explained, GMX *cyk, int **ret_ct,
			      THRESH *thresh, char *errbuf, int verbose);
