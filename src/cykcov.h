...
extern int   CYKCOV(ESL_RANDOMNESS *r, struct mutual_s *mi, CLIST *clist, int *ret_nct, int ***ret_ctlist, CLIST ***ret_exclude,
		    int ncvpairs, int minloop, THRESH *thresh,  char *errbuf, int verbose);
extern int   CYKCOV_Structures(ESL_RANDOMNESS *rng, struct mutual_s *mi, CLIST *clist, int *ret_nct, int ***ret_ctlist, CLIST ***ret_exclude,
			       int ncvpairs, int minloop, THRESH *thresh, char *errbuf, int verbose) ;
