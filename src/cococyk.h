...
extern int COCOCYK_G6_Traceback( ESL_RANDOMNESS *r, G6param  *p, ESL_SQ *sq, int *ct, G6_MX  *cyk, int **ret_cct, char *errbuf, int verbose);
extern int COCOCYK_G6S_Traceback(ESL_RANDOMNESS *r, G6Sparam *p, ESL_SQ *sq, int *ct, G6_MX  *cyk, int **ret_cct, char *errbuf, int verbose); 
extern int COCOCYK_BGR_Traceback(ESL_RANDOMNESS *r, BGRparam *p, ESL_SQ *sq, int *ct, BGR_MX *cyk, int **ret_cct, char *errbuf, int verbose); 
