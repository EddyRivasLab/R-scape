...
extern int       struct_ctlist_MAP(int L, CTLIST *ctlist, int OL, int *msamap, CTLIST **ret_octlist, char ***ret_sslist, FILE *fp, char *errbuf, int verbose);
...
extern void      struct_rm_Write(FILE *fp, RM *rm, int *msamap, int firstpos);
...
extern void      struct_rmlist_Write(char *rmlistfile, RMLIST *rmlistt, int *msamap, int firstpos);
