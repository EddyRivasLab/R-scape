...
extern int msamanip_RemoveGapColumns(double gapthresh, ESL_MSA *msa, char *errbuf, int verbose);
...
extern int msamanip_ShuffleColums(ESL_RANDOMNESS  *r, ESL_MSA *msa, ESL_MSA **ret_shmsa, char *errbuf, int verbose);
