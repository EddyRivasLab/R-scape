...
extern int CACO_RBG_R3D_GetParam    (R3D *red, RBGparam **ret_rbgp, R3Dparam **ret_r3dp, double bp_cov_frac, char *errbuf, int verbose);
extern int CACO_RBGJ3J4_R3D_GetParam(R3D *red, RBGparam **ret_rbgp, R3Dparam **ret_r3dp, double bp_cov_frac, char *errbuf, int verbose);
