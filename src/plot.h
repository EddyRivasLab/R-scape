...
extern int   plot_gplot_Histogram(char *gnuplot, char *plotf, int Nf, char **hisfile, char *xlabel, int samerange, char *errbuf, int verbose);
extern int   plot_gplot_XYfile(char *gnuplot, char *pdffile, char *file, int xfield, int yfield, char *xlabel, char *ylabel, char *errbuf);
...
extern int   plot_gplot_JointBinnedRatesWithLinearRegression(char *gnuplot, char *pdffile, int Nf, char **ratefile, float bintime, float tlinear,
