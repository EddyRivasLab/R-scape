...
extern int   er_CIF_GetSeq(char *pdffile, char *chainname, int *ret_from, int *ret_to, char **ret_sq, int **ret_ismissing, char *errbuf);
extern int   er_PrintChainSeqs(char *pdbfile, char *user_chain, char *ChainID, long num_residue, long **seidx, char **ResName,
			       ...
			       long *ret_nchain, char **ret_chain_name, long **ret_chain_f, long **ret_chain_t, char *extension, char *errbuf);
