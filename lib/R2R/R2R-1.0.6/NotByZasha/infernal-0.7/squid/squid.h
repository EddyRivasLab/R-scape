/* NotByZasha/infernal-0.7/squid/squid.h.  Generated from squid.h.in by configure. */
/*****************************************************************
...
typedef uint16_t sqd_uint16;
typedef uint32_t sqd_uint32;
typedef uint64_t sqd_uint64;
